...
wp_register_script( 'moredeal_aigc_template_index_script', ResConstant::MOREDEAL_AIGC_TEMPLATE_INDEX_SCRIPT, array( 'moredeal_aigc_template_vendor_script' ), Plugin::script_version(), true );
