 ...
 */
class ChatTemplateManager extends TemplateManager {

    /**
     * @var string 模版路径
     */
    const TEMPLATE_PATH = 'chat';

    /**
     * @var string 自定义模版路径
     */
    const CUSTOM_TEMPLATE_PATH = 'moredeal-ai-writer/templates';

    /**
     * @var string 模版前缀
     */
    const TEMPLATE_PREFIX = 'aigc_chat_';
